...
#undef LNNoEscape
#define LNNoEscape __attribute__((noescape))
 ...
 */
- (void)presentPopupBarWithContentViewController:(UIViewController*)controller animated:(BOOL)animated completion:(nullable LNNoEscape void(^)(void))completion;
 ...
 * @param completion      The block to execute after the presentation finishes. This block has no return value and takes no parameters. You may specify @c nil for this parameter.
 */
- (void)presentPopupBarWithContentViewController:(UIViewController*)controller openPopup:(BOOL)openPopup animated:(BOOL)animated completion:(nullable LNNoEscape void(^)(void))completion;
 ...
 */
- (void)openPopupAnimated:(BOOL)animated completion:(nullable LNNoEscape void(^)(void))completion;
 ...
 */
- (void)closePopupAnimated:(BOOL)animated completion:(nullable LNNoEscape void(^)(void))completion;
 ...
 */
- (void)dismissPopupBarAnimated:(BOOL)animated completion:(nullable LNNoEscape void(^)(void))completion;
