...
- (void)layoutSubviews
{
	...
	//Reset the semantic content attribute to make sure it propagades to all subviews.
...
{
	//Due to a bug in UIKit, the semantic content attribute must be propagaded recursively to all subviews, so that the system behaves correctly.
